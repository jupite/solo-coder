...
import { Loader2, LogIn, Crown, Grid3X3, Pencil, Edit2, Trash2, Play, CheckCircle, AlertCircle, Globe, Globe2, ArrowLeft } from 'lucide-react';
...
export default function SoloLevelsPage() {
