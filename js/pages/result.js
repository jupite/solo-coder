class ResultPage {
    ...
    showResult(isWin, playerPokemon, enemyPokemon, turns) {
        if (isWin) {
    ...
    renderPokemonPreview(side, pokemon) {
    ...
    renderPokemon3D(renderer, pokemon, time) {
    ...
    drawPokemonShape(renderer, pokemon, time) {
    ...
    updateStats(isWin, playerPokemon, enemyPokemon, turns) {
