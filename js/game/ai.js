class PokemonAI {
    ...
    selectMove(aiPokemon, playerPokemon) {
    ...
    selectSemiSmartMove(moves, aiPokemon, playerPokemon) {
    ...
    selectSmartMove(moves, aiPokemon, playerPokemon) {
        const moveScores = moves.map(move => {
            let score = 0;
    ...
    calculateTotalEffectiveness(moveType, defenderTypes) {
    ...
    selectTargetPokemon(availablePokemon, opponentPokemon) {
