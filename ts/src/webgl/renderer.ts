...
export class WebGLRenderer {
  ...
  constructor(canvas: HTMLCanvasElement) {
    ...
    this.lightPositionUniform = null;
    this.lightColorUniform = null;
    this.ambientStrengthUniform = null;
    this.diffuseStrengthUniform = null;
    this.specularStrengthUniform = null;
    this.shininessUniform = null;
